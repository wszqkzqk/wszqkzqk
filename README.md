...
- Leader & Maintainer of [Loong Arch Linux](https://github.com/lcpu-club/loongarch-packages)
- 🐍 Use Python
...
- 😉 目前是 Arch Linux 用户
  ...
  - 喜欢 pacman 的简洁设计
  - 喜欢滚动更新
- [Loong Arch Linux](https://github.com/lcpu-club/loongarch-packages) 项目负责人，维护者
- 🐍 使用 Python
